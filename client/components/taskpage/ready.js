    ...
    render(){
        ...
        return (
            <div>
                ...
                <p className="taskHeader" style={{"display": (task_type.includes("training"))?"block":"none"}}>If you give right input within 0.8 seconds, you will get a point.<br/> If you get more than 16 points, you would be able to proceed. <br/> If not, you will do the 20 training tasks again.</p>
