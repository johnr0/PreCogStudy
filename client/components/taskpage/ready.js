    ...
    render(){
        ...
        return (
            <div>
                ...
                <p className="taskHeader" style={{"display": (task_type.includes("training"))?"block":"none"}}>The text will be shown like below, showing either of "Movable" or "Won't move". Also, they will be randomly positioned on left or right.</p>
