...
class Instruction extends Component{
    ...
    render(){
        ...
        return (
            <div>
                <h4>This task is to discern whether an object 'can' be dangerous to our vehicle in near future.</h4>
                <p>You will watch a 1st point-of-view video of car driving down a road.</p>
                <p>Shortly, you will see an object that is marked with <span style={{"color":"green"}}>green box</span>.</p>
